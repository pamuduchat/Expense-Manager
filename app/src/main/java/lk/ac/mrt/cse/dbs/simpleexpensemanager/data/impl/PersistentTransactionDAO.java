...
public class PersistentTransactionDAO implements TransactionDAO {
    ...
    public void logTransaction(Date date, String accountNo, ExpenseType expenseType, double amount) {
        ...
        rowValues.put(COL_ACCNO,accountNo);
        rowValues.put(COl_DATE, dateFormat.format(date));
        rowValues.put(COL_AMOUNT,amount);
        rowValues.put(COL_EXPENSETYPE,String.valueOf(expenseType));
        SQLdatabase.insert(TABLE_TRANSACTION,null,rowValues);
        SQLdatabase.close();
    ...
    public List<Transaction> getAllTransactionLogs() throws ParseException {
        ...
        Cursor cursor = SQLdatabase.query( //generate quary
                TABLE_TRANSACTION,
                new String[]{COl_DATE, COL_ACCNO, COL_EXPENSETYPE, COL_AMOUNT},
                null,
                null,
                null,
                null,
